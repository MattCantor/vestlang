...
function peg$parse(input, options) {
  ...
  function peg$f30(o) {    error("EVERY must be provided when OVER is present");  }
  function peg$f31(e) {    error("OVER must be provided when EVERY is present");  }
