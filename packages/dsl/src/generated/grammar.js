...
function peg$parse(input, options) {
  ...
  const peg$e14 = peg$classExpectation([["0", "1"]], false, false, false);
  const peg$e15 = peg$literalExpectation("/", false);
  const peg$e16 = peg$literalExpectation("day", true);
  const peg$e17 = peg$literalExpectation("s", false);
  const peg$e18 = peg$literalExpectation("month", true);
  const peg$e19 = peg$literalExpectation("week", true);
  const peg$e20 = peg$literalExpectation("year", true);
  const peg$e21 = peg$literalExpectation("DATE", true);
  const peg$e22 = peg$literalExpectation("-", false);
  const peg$e23 = peg$classExpectation([["0", "3"]], false, false, false);
  const peg$e24 = peg$literalExpectation("EVENT", true);
  const peg$e25 = peg$literalExpectation("(", false);
  const peg$e26 = peg$literalExpectation(")", false);
  const peg$e27 = peg$literalExpectation("BEFORE", true);
  const peg$e28 = peg$literalExpectation("AFTER", true);
  const peg$e29 = peg$literalExpectation("EARLIER", true);
  const peg$e30 = peg$literalExpectation("LATER", true);
  const peg$e31 = peg$literalExpectation("OF", true);
  const peg$e32 = peg$literalExpectation("OVER", true);
  const peg$e33 = peg$literalExpectation("EVERY", true);
  const peg$e34 = peg$literalExpectation("FROM", true);
  ...
  function peg$f19(name) {    return mkEvent(name);  }
  function peg$f20(base, offsets, conditions) {
    return {
  ...
  function peg$f29(o) {    error("EVERY must be provided when OVER is present");  }
  function peg$f30(e) {    error("OVER must be provided when EVERY is present");  }
  function peg$f31() {    return {
           type: "DAYS",
           length: 0,
           occurrences: 1
         };  }
  function peg$f32(a) {    return a;  }
  function peg$f33(a) {    return a;  }
  function peg$f34(f, p, c) {
    const base = {
      type: "SINGLETON",
      vesting_start: f ?? {
        type: "BARE",
